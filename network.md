...
### ICMP
**作用**：被主机和路由器用于传送网络层面的控制信息      
•错误报告：主机、网络、端口和协议不可达            
•回声请求/响应（被ping使用）      
在IP协议之“上”• ICMP报文被携带于IP数据报中             
...
## 链路层
**作用**：负责将IP数据报通过链路从一个节点传送到物理上相邻的（同在一个IP子网的）另外一个节点            
**在哪里实现的**：在每台主机、路由器的网卡上，或者交换机的网口上，链路层（和相应的物理层）实现于网络接口卡或者芯片上       
...
•要有从碰撞中恢复的机制      
3. **轮次（依次轮流）**         
•节点轮流使用，拥有很多数据传输的节点会得到更多的轮转使用时间

### 信道划分
#### TDMA

<img width="986" height="531" alt="image" src="https://github.com/user-attachments/assets/53ac5384-4fb8-4374-a2b6-4d9f6a1940a4" />

#### FDMA

<img width="920" height="514" alt="image" src="https://github.com/user-attachments/assets/814ccabe-8084-4613-8390-0d3830fcd226" />
...
最小帧长度
<img width="897" height="161" alt="image" src="https://github.com/user-attachments/assets/92af8aa2-7a45-4aee-a064-458d1c0d32e1" />
